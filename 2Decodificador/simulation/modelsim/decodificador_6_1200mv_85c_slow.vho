...
-- S[4]	=>  Location: PIN_L5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- S[5]	=>  Location: PIN_L4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- S[6]	=>  Location: PIN_M4,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Mux6~0_combout\ = (\A[1]~input_o\ & (\A[3]~input_o\)) # (!\A[1]~input_o\ & (\A[2]~input_o\ $ (((!\A[3]~input_o\ & \A[0]~input_o\)))))
...
-- Equation(s):
-- \Mux5~0_combout\ = (\A[3]~input_o\ & (((\A[2]~input_o\) # (\A[1]~input_o\)))) # (!\A[3]~input_o\ & (\A[2]~input_o\ & (\A[0]~input_o\ $ (\A[1]~input_o\))))
...
-- Equation(s):
-- \Mux4~0_combout\ = (\A[2]~input_o\ & (\A[3]~input_o\)) # (!\A[2]~input_o\ & (\A[1]~input_o\ & ((\A[3]~input_o\) # (!\A[0]~input_o\))))
...
-- Equation(s):
-- \Mux3~0_combout\ = (\A[1]~input_o\ & ((\A[3]~input_o\) # ((\A[0]~input_o\ & \A[2]~input_o\)))) # (!\A[1]~input_o\ & (\A[2]~input_o\ $ (((!\A[3]~input_o\ & \A[0]~input_o\)))))
...
-- Equation(s):
-- \Mux2~0_combout\ = (\A[0]~input_o\) # ((\A[1]~input_o\ & (\A[3]~input_o\)) # (!\A[1]~input_o\ & ((\A[2]~input_o\))))
...
-- Equation(s):
-- \Mux1~0_combout\ = (\A[0]~input_o\ & ((\A[1]~input_o\) # (\A[3]~input_o\ $ (!\A[2]~input_o\)))) # (!\A[0]~input_o\ & ((\A[2]~input_o\ & (\A[3]~input_o\)) # (!\A[2]~input_o\ & ((\A[1]~input_o\)))))
...
-- Equation(s):
-- \Mux0~0_combout\ = (\A[2]~input_o\ & (!\A[3]~input_o\ & ((!\A[1]~input_o\) # (!\A[0]~input_o\)))) # (!\A[2]~input_o\ & (\A[3]~input_o\ $ (((\A[1]~input_o\)))))
